...
angular.module('GoogleDirection', [])
    .controller('googlemapoutput', function ($scope,$http) {
        ...
        $scope.getWeather = function () {
            ...
            $http.get('http://api.openweathermap.org/data/2.5/weather?q='+document.getElementById('Departure').value+'&appid=31bd556b96df84d2e1f5b145f1d665fc').success(function(data){
            ...
            $http.get('http://api.openweathermap.org/data/2.5/weather?q='+document.getElementById('Arrival').value+'&appid=31bd556b96df84d2e1f5b145f1d665fc').success(function(data){
