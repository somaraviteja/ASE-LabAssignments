...
public class  MainActivity extends WearableActivity implements OnMapReadyCallback,
    ...
    private static final LatLng overlandpark = new LatLng(38.98,-94.67);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(overlandpark)
                .title("overland park Kansas City "));

        // Move the camera to show the marker.
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(overlandpark, 10));
    }
